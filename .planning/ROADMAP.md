...
- [x] 06-01-PLAN.md — Fix the Jest harness (`@/*` alias, bare `.astro/config.generated.json` import, `import.meta` under real ESM) and cover handleDraftPage, buildToc, navigationActive, JsonLdGenerator, absoluteUrl (tracer + expansion, Wave 1)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 06-02-PLAN.md — Cover generateTypeScale, readingTime, filteredEnabled (Wave 2)
- [x] 06-03-PLAN.md — Cover overrideObjects, removeEmptyKeys, uniqueIdGenerator (Wave 2)
- [x] 06-04-PLAN.md — Cover getRelatedContent, preline (Wave 2, phase completion)
